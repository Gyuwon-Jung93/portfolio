...
function updateDublinDate() {
    ...
    const dublinDate = new Date().toLocaleDateString('en-US', options);
    document.getElementById('currentDate').textContent = dublinDate;
}
...
setInterval(updateDublinDate, 24 * 60 * 60 * 1000);
